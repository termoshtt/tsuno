...
///
/// This type represents the fixed matrix produced by the initial
/// factorization. Simplex basis updates such as product-form eta updates live
/// in [`crate::simplex::Basis`], because they update the current simplex basis
/// rather than the low-level factorization of one fixed matrix.
#[derive(Debug)]
pub struct LU {
    nrows: usize,
    ncols: usize,
